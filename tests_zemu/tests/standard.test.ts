...
describe("Standard", function () {
  ...
  test.concurrent.each(models)("[Deploy] sign basic normal (%s)", async function (m) {
    const sim = new Zemu(m.path);
    try {
      await sim.start({ ...defaultOptions, model: m.name });
      const app = new CasperApp(sim.getTransport());
  ...
  test.concurrent.each(models)("[Deploy] sign expert transfer(%s)", async function (m) {
    const sim = new Zemu(m.path);
    try {
      await sim.start({ ...defaultOptions, model: m.name });
      const app = new CasperApp(sim.getTransport());
  ...
  test.concurrent.each(models)("[Deploy] sign basic delegation (%s)", async function (m) {
    const sim = new Zemu(m.path);
    try {
      await sim.start({ ...defaultOptions, model: m.name });
      const app = new CasperApp(sim.getTransport());
  ...
  test.concurrent.each(models)("[Deploy] sign generic native transfer(%s)", async function (m) {
    const sim = new Zemu(m.path);
    try {
      await sim.start({ ...defaultOptions, model: m.name });
      const app = new CasperApp(sim.getTransport());
  ...
  test.concurrent.each(models)("[Deploy] sign generic delegation (%s)", async function (m) {
    const sim = new Zemu(m.path);
    try {
      await sim.start({ ...defaultOptions, model: m.name });
      const app = new CasperApp(sim.getTransport());
  ...
  test.concurrent.each(models)("[Deploy] sign wasm deploy", async function (m) {
    const sim = new Zemu(m.path);
    try {
      await sim.start({ ...defaultOptions, model: m.name });
      const app = new CasperApp(sim.getTransport());
