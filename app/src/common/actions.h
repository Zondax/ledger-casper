...
__Z_INLINE void app_sign() {
  ...
  zxerr_t err = crypto_sign(G_io_apdu_buffer, IO_APDU_BUFFER_SIZE - 3, message,
                            messageLength, &replyLen);
...
__Z_INLINE zxerr_t app_fill_address() {
  ...
  zxerr_t err = crypto_fillAddress(G_io_apdu_buffer, IO_APDU_BUFFER_SIZE - 2,
